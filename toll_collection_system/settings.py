"""
Django settings for toll_collection_system project.
...
SECRET_KEY = 'django-insecure-3=1^ujltv0j4*gw=nyxd56m@(1&=n^j&5ir91f1thcd=1*)&*l'
...
ROOT_URLCONF = 'toll_collection_system.urls'
...
AUTH_USER_MODEL = 'toll_app.UserDetails'
